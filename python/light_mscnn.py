...
#more lightweight CNN architecture. 
# 
...
dens1 = Dense(128)(concat)
drop3 = Dropout(rate=0.5)(dens1)
#Output classification layer with softmax
#activation function
dens2 = Dense(43)(drop3)
act3 = Activation('softmax')(dens2)
#Create model instance with input and outputs
model = Model(inputs=[input], outputs=[act3])
...
model.save('../models/light_mscnn.h5')
